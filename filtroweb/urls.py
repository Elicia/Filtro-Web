...
from principal.views import IndexAboutView, MyLogin, Cerrar, Privado, UsuarioDetailView, RegistrarUsuario, VerPerfiles, NuevoPerfil, PaginaWebDetail
...
urlpatterns = patterns('',
    ...
    url(r'^paginas/(?P<pk>\d+)/$', PaginaWebDetail.as_view(), name='detalle_paginaweb'),
